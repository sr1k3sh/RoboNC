...
public class Utils 
{
	...
	public static Bitmap makeBitmapFromAssets(Context context,String $id) {
		InputStream is = null;
		Bitmap myBitmap = null;
		try {
			is = context.getAssets().open($id);
			Log.d("rikesh", "makeBitmapFromAssets: "+is);
		...
		Log.d("rikesh", "makeBitmapFromAssets: "+myBitmap);
		return myBitmap;
	}
	public static Bitmap makeBitmapFromAssets(String $id) {
		return makeBitmapFromAssets(Shared.context(),$id);
	}
	/**
