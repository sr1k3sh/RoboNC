...
public class Vertices
{
	 ...
	 * 
	 * Direct manipulation of position, UV, normal_mtl, or color data can be done directly through the associated
	 ...
	 * uv, normal_mtl, and color lists will be used by this instance.
