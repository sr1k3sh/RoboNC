...
import com.arrtsm.app.woodapp.GlobalClass;
...
public class ObjectRenderer {
    ...
    public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
        ...
        // Read the texture.
        /*InputStream is = null;
        URL url = new URL(diffuseTextureAssetName);
        Log.d("imageurl", "createOnGlThread: "+url);
        ...
        Log.d("imageurl", "createOnGlThread: "+textureBitmap);
        ...
        File file = new File(path,objAssetName);
        FileInputStream fileInputStream = new FileInputStream(file);
        //InputStream objInputStream = context
        Obj obj = ObjReader.read(fileInputStream);
